export default function Terms() {
  return (
    <article className="mx-auto py-8 prose prose-neutral dark:prose-invert">
      ...
      <p>
        These terms and conditions applies to the Absensi Online NL app (hereby
      ...
      <p>These terms and conditions are effective as of 2024-08-15</p>
      <h2>Contact Us</h2>
      <p>
